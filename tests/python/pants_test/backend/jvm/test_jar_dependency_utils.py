...
class JarDependencyUtilsTest(unittest.TestCase):
  def test_m2_string_representation(self):
    ...
    self.assertEqual('org.example:lib:the-ref::jar', str(org_name_ref))
    ...
    self.assertEqual('org.example:lib:the-ref:classify:jar', str(org_name_ref_classifier))
    ...
    self.assertEqual('org.example:lib::classify:jar', str(org_name_classifier))
    ...
    self.assertEqual('org.example:lib::classify:zip', str(org_name_type_classifier))
    ...
    self.assertEqual('org.example:lib::classify:jar', str(org_name_type_jar_classifier))
