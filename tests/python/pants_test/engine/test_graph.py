...
class GraphTest(unittest.TestCase):
  ...
  def test_invalidate_partial(self):
    ...
    pg_structure = {n: e.structure() for n, e in list(self.pg._nodes.items())}
    comparison_structure = {n: e.structure() for n, e in list(comparison_pg._nodes.items())}
  ...
  def test_invalidate_partial_identity_check(self):
    ...
    for node, entry in list(self.pg._nodes.items()):
