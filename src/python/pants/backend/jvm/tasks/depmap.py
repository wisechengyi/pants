...
class Depmap(ConsoleTask):
  ...
  def register_options(cls, register):
    ...
    register('--is-internal-only', default=False, action='store_true',
    ...
    register('--is-external-only', default=False, action='store_true',
    ...
    register('--separator', default='-', action='store',
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.is_internal_only = self.get_options().is_internal_only
    self.is_external_only = self.get_options().is_external_only

    if (self.is_internal_only and self.is_external_only):
      cls = self.__class__
      error_str = "At most one of {internal} or {external} can be selected.".format(
        internal=self.is_internal_only, external=self.is_external_only)
