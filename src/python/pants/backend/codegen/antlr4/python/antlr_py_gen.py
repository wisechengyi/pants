...
# However, this refactoring will only  make sense once we modify PythonAntlr4Library
# as explained below.
class Antlr4PyGen(SimpleCodegenTask, NailgunTask):
    """Generate Python source code from ANTLR grammar files."""

    gentarget_type = PythonAntlr4Library
    ...
    def is_gentarget(self, target):
        return isinstance(target, PythonAntlr4Library)
    ...
    def execute_codegen(self, target, target_workdir):
        ...
        args = ["-Dlanguage=Python3", "-o", output_dir, "-Xexact-output-dir", *sources]
        result = self.runjava(
